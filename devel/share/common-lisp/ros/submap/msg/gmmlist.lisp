...
(cl:defclass <gmmlist> (roslisp-msg-protocol:ros-message)
  ((data
    :reader data
    :initarg :data
    :type (cl:vector submap-msg:gmm)
   :initform (cl:make-array 0 :element-type 'submap-msg:gmm :initial-element (cl:make-instance 'submap-msg:gmm))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <gmmlist>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gmmlist)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name submap-msg:<gmmlist> is deprecated: use submap-msg:gmmlist instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <gmmlist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader submap-msg:data-val is deprecated.  Use submap-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <gmmlist>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'submap-msg:gmm))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<gmmlist>)))
  ...
  "4c92093a5576792fccd432d7e99ff275")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'gmmlist)))
  "Returns md5sum for a message object of type 'gmmlist"
  "4c92093a5576792fccd432d7e99ff275")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<gmmlist>)))
  ...
  (cl:format cl:nil "gmm[] data~%~%================================================================================~%MSG: submap/gmm~%std_msgs/Header header~%uint8 mix_num~%float32[] prior~%float32[] x~%float32[] y~%float32[] z~%float32[] x_var~%float32[] y_var~%float32[] z_var  ~%geometry_msgs/Pose pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'gmmlist)))
  "Returns full string definition for message of type 'gmmlist"
  (cl:format cl:nil "gmm[] data~%~%================================================================================~%MSG: submap/gmm~%std_msgs/Header header~%uint8 mix_num~%float32[] prior~%float32[] x~%float32[] y~%float32[] z~%float32[] x_var~%float32[] y_var~%float32[] z_var  ~%geometry_msgs/Pose pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
